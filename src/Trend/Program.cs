...
namespace Trend
{
    class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var formattedMatrix = ProcessDataAndGetFormattedMatrix(fileName, c, n);
        ...
        private static string ProcessDataAndGetFormattedMatrix(string fileName, int c, int n)
        {
            ...
            return DataFormatter.GetValuesFormattedAsMatrix(c, calculatedValues);
        }
    }
}
